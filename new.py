...
class Window(Frame):
    ...
    def initfirst(self,state):
        can = Canvas(self, height=100, width=20)
        can.place(relx=0.5, rely=0.5, anchor=CENTER)
        button1 = Button(root,  text="Press ENTER to Confirm", bg="Green", fg="Black",width=20, command=lambda:Window.nextwindow(self),font = ("TimesNewRoman 24"), justify="center")
